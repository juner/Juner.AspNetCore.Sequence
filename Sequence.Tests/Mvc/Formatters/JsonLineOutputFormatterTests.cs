...
using OutputFormatter = Juner.AspNetCore.Sequence.Mvc.Formatters.JsonLineOutputFormatter;

namespace Juner.AspNetCore.Sequence.Mvc.Formatters;

[TestClass]
public class JsonLineOutputFormatterTests
{
    ...
    static IEnumerable<object?[]> CanWriteResultTestData
    {
        get
        {
            ...
            yield return CanWriteResult("application/jsonl", typeof(IAsyncEnumerable<int>), true);
            yield return CanWriteResult("application/jsonl", typeof(IEnumerable<int>), true);
            yield return CanWriteResult("application/jsonl", typeof(List<int>), true);
            yield return CanWriteResult("application/json", typeof(IAsyncEnumerable<int>), false);
            // 文字列は対応していない
            yield return CanWriteResult("application/jsonl", typeof(string), false);
