...
public class NdJsonOutputFormatterTests
{
    ...
    static IEnumerable<object?[]> CanWriteResultTestData
    {
        get
        {
            ...
            yield return CanWriteResult("application/x-ndjson", typeof(IAsyncEnumerable<int>), true);
            yield return CanWriteResult("application/x-ndjson", typeof(IEnumerable<int>), true);
            yield return CanWriteResult("application/x-ndjson", typeof(List<int>), true);
            yield return CanWriteResult("application/json", typeof(IAsyncEnumerable<int>), false);
            // 文字列は対応していない
            yield return CanWriteResult("application/x-ndjson", typeof(string), false);
