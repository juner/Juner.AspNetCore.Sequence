...
<script type="module">
import { InputJsonSequenceStream } from 'https://cdn.jsdelivr.net/npm/json-seq-stream@1.0.10/+esm'
...
function info(value) {
    const info = templateInfo.content.firstChild.cloneNode(true);
...
<div>
<input type=number id=additionNum value=0 />
<button id=additionButton>add</button>
<button id=resultButton>result</button>
<span id=result></span>
</div>
<div id=outputTarget>
    <template id=templateInfo><div class="info"></div></template>
